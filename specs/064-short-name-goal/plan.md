...
- Shadcn UI components (Radix UI primitives + Tailwind styling):
  ...
  - **Installation**: `npx shadcn@latest add progress toast skeleton empty dropdown-menu`
...
frontend/src/shared/components/ui/    # Shadcn UI components (INSTALL 5 NEW)
...
├── progress.tsx                       # ❌ NEW - MUST ADD - Goal progress bars
├── toast.tsx + use-toast.ts          # ❌ NEW - MUST ADD - Undo notifications
├── skeleton.tsx                       # ❌ NEW - SHOULD ADD - Loading placeholders
├── empty.tsx                          # ❌ NEW - SHOULD ADD - Empty state
└── dropdown-menu.tsx                  # ❌ NEW - SHOULD ADD - Goal action menus
