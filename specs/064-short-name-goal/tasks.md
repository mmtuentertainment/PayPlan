...
- [X] T001 Install Shadcn UI components via CLI: `npx shadcn@latest add progress sonner skeleton empty dropdown-menu` (adds 5 components to frontend/src/shared/components/ui/) - NOTE: Used sonner instead of deprecated toast
