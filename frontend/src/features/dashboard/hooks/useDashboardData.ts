...
import {
  ...
  getUpcomingBills,
  getGoalProgress,
} from "@/features/dashboard/lib/aggregation";
import { getGamificationData } from "@/features/dashboard/lib/gamification";
import type {
  SpendingChartData,
  IncomeExpensesChartData,
} from "@/features/dashboard/types/chart-data";
import type { Transaction } from "@/features/transactions/types/transaction";
import type { UpcomingBill } from "@/shared/types/bill";
import type { GoalProgress } from "@/shared/types/goal";
import type { GamificationData } from "@/features/dashboard/types/gamification";
