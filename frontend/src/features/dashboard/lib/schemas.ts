 ...
 * Type definition: @/features/dashboard/types/chart-data (SpendingChartData interface)
 */
 ...
 * Type definition: @/features/dashboard/types/chart-data (IncomeExpensesChartData interface)
 */
 ...
 * Type definition: @/shared/types/bill (UpcomingBill interface)
 */
 ...
 * Type definition: @/shared/types/goal (GoalProgress interface)
 */
...
/**
 * Streak data schema
 * Type definition: @/features/dashboard/types/gamification (StreakData interface)
 */
...
/**
 * Recent win schema
 * Type definition: @/features/dashboard/types/gamification (RecentWin interface)
 */
 ...
 * Type definition: @/features/dashboard/types/gamification (PersonalizedInsight interface)
 */
 ...
 * Type definition: @/features/dashboard/types/gamification (GamificationData interface)
 */
